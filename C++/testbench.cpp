...
SC_MODULE (Source) {
  ...
  // sc_in<float>   qs[2];
  // sc_in<float>   qf[2];
  // sc_in<float>   obs[MAX_NUMBER_OBS][3];
  // sc_out<float>  configurations[MAX_NUMBER_CONFIGS][3];
  ...
  void start() {
    ...
    start_position_list[1] = 2;
    RRT::InputType end_position_list[2];
    end_position_list[0] = 2;
